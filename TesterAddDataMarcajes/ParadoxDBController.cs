...
namespace CampanillasControlPrototype
{
    ...
    {     
        ...
        {
            OleDbCommand cmd = new OleDbCommand("INSERT INTO Marcajes (Persona,Fecha,Hora,Terminal,Modificado,ModoIdentificacion) VALUES ("+pid+",'" + DateTime.Now.ToShortDateString() + "','" + DateTime.Now.ToShortTimeString() + "',1,true,0);", mConnection);
